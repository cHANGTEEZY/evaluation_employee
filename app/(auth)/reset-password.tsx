...
const ResetPassword = () => {
    ...
    const onSubmit = async (values: ResetPasswordSchema) => {
        ...
        try {
            ...
            setSnackMessage(error?.message || "Failed to reset password. Please try again.");
            setSnackVisible(true);
            console.error(error);
        }
        finally {
    ...
    const renderPasswordField = (name: "newPassword" | "confirmPassword", label: string, placeholder: string, show: boolean, toggle: () => void) => (<View style={styles.inputContainer}>
      ...
      {form.formState.errors[name]?.message && (<Text style={[styles.errorText, { color: colors.errorText }]}>
