import { z } from "zod";
export function normalizeBuildingRatePerSqftInput(raw: unknown): (number | undefined)[] | undefined {
    if (raw == null)
        return undefined;
...
export const valuationSchema = z.object({
    ...
    building_age_years: z
        ...
        .optional(),
    building_rate_per_sqft: z.preprocess(normalizeBuildingRatePerSqftInput, z.array(z.number().nonnegative().optional()).optional()),
