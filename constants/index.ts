...
const DEV_API_URL = "https://evaluation-backend-production-dac9.up.railway.app";
...
export const BASE_API_URL = getExtra().apiUrl?.trim() ||
    process.env.EXPO_PUBLIC_API_URL?.trim() ||
    DEFAULT_API_URL;
export function getGalliMapsApiKey(): string {
    return (getExtra().galliMapsApiKey?.trim() ||
