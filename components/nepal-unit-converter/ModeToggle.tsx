...
const ModeToggle = ({ value, onValueChange }: ModeToggleProps) => {
    ...
    return (<View style={[
      ...
      <Pressable onPress={() => onValueChange("area")} style={[
            styles.segment,
            value === "area" && {
        ...
        <MaterialCommunityIcons name="image-filter-hdr" size={20} color={value === "area"
      ...
      <Pressable onPress={() => onValueChange("length")} style={[
            styles.segment,
            value === "length" && {
                backgroundColor: theme.colors.primaryContainer ?? theme.colors.primary,
                borderRadius: 10,
        ...
        <MaterialCommunityIcons name="ruler" size={20} color={value === "length"
            ? (theme.colors.onPrimaryContainer ?? theme.colors.onPrimary)
            : theme.colors.onSurfaceVariant}/>
        <Text variant="labelLarge" style={[
            styles.label,
