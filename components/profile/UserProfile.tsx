      ...
      <View style={[
        ...
        <View style={styles.heroRow}>
          <View style={styles.avatarWrap}>
            {displayUser.image ? (<Avatar.Image size={64} source={{ uri: displayUser.image }}/>) : (<Avatar.Icon size={64} icon="account" style={{ backgroundColor: theme.colors.primaryContainer }}/>)}
          </View>
          <View style={styles.heroText}>
            <Text variant="titleLarge" style={[styles.name, { color: theme.colors.onSurface }]} numberOfLines={1}>
              {displayUser.name}
            </Text>
            <View style={[
            styles.roleChip,
