...
export default function OrganizationDetails() {
    ...
    if (!organization) {
        ...
        <View style={styles.empty}>
          <MaterialCommunityIcons name="domain-off-outline" size={40} color={theme.colors.onSurfaceVariant}/>
    ...
    return (<View style={[styles.wrapper, { borderTopColor: theme.colors.outlineVariant }]}>
      <Text style={[
            styles.sectionTitle,
            SECTION_LABEL,
            { color: theme.colors.onSurfaceVariant },
